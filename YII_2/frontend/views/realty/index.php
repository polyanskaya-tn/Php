...
<div id="iceslideshow">
	...
	<div class="container">
        ...
        <div class="carousel-inner">
					...
					<img src="images/image1.jpg" title="Welcome To IT Property 2" alt="Welcome To IT Property 2" height="600px" width="1170px">	
				
					  </div>
										<div class="item">
					
					<img src="images/image2.jpg" title="Fully Real Estate Theme" alt="Fully Real Estate Theme" height="600px" width="1170px">	
												
					  </div>
										<div class="item active left">
					
					<img src="images/image3.jpg" title="Fully Responsive Theme" alt="Fully Responsive Theme" height="600px" width="1170px">	
             ...
             <div class="iceslideshow_arrow">
			  <a class="carousel-control left" href="#iceslideshow237" data-slide="prev">›</a>
			  <a class="carousel-control right" href="#iceslideshow237" data-slide="next">›</a>
              </div>
		</div><!-- .carousel -->
<!-- end carousel -->
...
<div id="ip_search">
	...
	<div class="container">
       ...
       <div class="moduletable">
							...
							<h3 class="mod-title">Search for thousands of homes</h3>
...
<? 
/*
	echo $form->field($model, 'sold')->dropDownList([
		'' => 'Sold',
		0 => 0,
		1 => 1
]);
*/
	/*echo $form->field($model, 'filter_keyword',[
								'template' => '
