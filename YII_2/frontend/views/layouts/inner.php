...
var ipmapoptions = {
        ...
        lat: "47.672527",
        lon: "-116.767967",
        mapicon: "/it_property2/components/com_iproperty/assets/images/map/icon56.png",
        maxZoom: 13,
        places: true,
        kml: ""    
    };
...
(function($){
				$(document).ready(function() {
					...
					var tab = $('<li class=" active"><a href="#propimages" data-toggle="tab">Images (1)</a></li>');
...
(function($){
				$(document).ready(function() {
					// Handler for .ready() called.
					var tab = $('<li class=""><a href="#propmap" data-toggle="tab">Map</a></li>');
					$('#ipMapTabs').append(tab);
				});
			})(jQuery);
jQuery(window).load(function($){    
			...
			var ratedata;
            jQuery(document).ready(function($){
				$.getJSON( '/it_property2/plugins/iproperty/currencytab/currencytab_proxy.php')
				.done(function( json ) {
					ratedata = json;
					ratedata['EUR'] = 1;
				})
...
(function($){
				$(document).ready(function() {
					// Handler for .ready() called.
					var tab = $('<li class=""><a href="#ipcurrency" data-toggle="tab">Convert</a></li>');
					$('#ipMapTabs').append(tab);
				});
			})(jQuery);
        ...
        jQuery(document).ready(function($){            
            ...
            var ddheight    = $('.ip-mapleft .tab-pane').css('height');
...
(function($){
				$(document).ready(function() {
					// Handler for .ready() called.
					var tab = $('<li class=""><a href="#ipdirectionsplug" data-toggle="tab">Get There</a></li>');
					$('#ipMapTabs').append(tab);
				});
			})(jQuery);
jQuery(window).load(function($){
...
(function($){
				$(document).ready(function() {
					// Handler for .ready() called.
					var tab = $('<li class=""><a href="#ipstreetviewplug" data-toggle="tab">Street</a></li>');
					$('#ipMapTabs').append(tab);
				});
			})(jQuery);
(function($){
...
(function($){
				$(document).ready(function() {
					// Handler for .ready() called.
					var tab = $('<li class=" active"><a href="#propdescription" data-toggle="tab">Overview</a></li>');
...
(function($){
				$(document).ready(function() {
					// Handler for .ready() called.
					var tab = $('<li class=""><a href="#propdetails" data-toggle="tab">Details</a></li>');
					$('#ipDetailsTabs').append(tab);
				});
			})(jQuery);
(function($){
				$(document).ready(function() {
					// Handler for .ready() called.
					var tab = $('<li class=""><a href="#propstf" data-toggle="tab">Send to a friend</a></li>');
					$('#ipDetailsTabs').append(tab);
				});
			})(jQuery);
...
(function($){
				$(document).ready(function() {
					// Handler for .ready() called.
					var tab = $('<li class=""><a href="#ipfbcommentplug" data-toggle="tab">Comments</a></li>');
					$('#ipDetailsTabs').append(tab);
				});
			})(jQuery);
(function($){
				$(document).ready(function() {
					// Handler for .ready() called.
					var tab = $('<li class=""><a href="#ipfindmyschoolukplug" data-toggle="tab">Schools</a></li>');
					$('#ipDetailsTabs').append(tab);
				});
			})(jQuery);
(function($){
				$(document).ready(function() {
					// Handler for .ready() called.
					var tab = $('<li class=""><a href="#ipgalleryplug" data-toggle="tab">Gallery</a></li>');
					$('#ipDetailsTabs').append(tab);
				});
			})(jQuery);
var gplacesOptions = {
...
(function($){
				$(document).ready(function() {
					// Handler for .ready() called.
					var tab = $('<li class=""><a href="#ipgplacesplug" data-toggle="tab">Google Places</a></li>');
					$('#ipDetailsTabs').append(tab);
				});
			})(jQuery);
...
jQuery(document).ready(function($){
    var url = '/it_property2/index.php?option=com_iproperty&format=raw&task=ajax.getLocOptions&08e99ca59c86f896732b0cf001e75ddb=1';
})
  </script>
  <script type="text/javascript">
    (function() {
  ...
  <meta property="og:title" content="94 Portland Rd ">
  <meta property="og:image" content="http://demo.icetheme.com/it_property2/media/com_iproperty/pictures/photo_12995_2009081151b6eda946e31.jpg">
  <meta property="og:url" content="http://demo.icetheme.com/it_property2/index.php/property?view=property&amp;id=8:portland-st-2-bed-1-bath">
  <meta property="og:site_name" content="IT Property 2">
  <meta property="og:type" content="website">
  <meta property="og:description" content="Genitus vindico velit, gemino feugait utinam pneum fere sed valetudo sino iriure distineo abbas defui. Quod consequat oppeto tation aliquip dignissim comis, autem tation importunus imputo inhibeo illum minim fere. Et neo pala odio vereor ex tum duis paulatim vulputate exputo praesent.">
...
<!-- Template Styles  -->
<link id="stylesheet" rel="stylesheet" type="text/css" href="94%20Portland%20Rd_files/style1.css">

<!-- Resposnive Template Styles -->
<link id="stylesheet-responsive" rel="stylesheet" type="text/css" href="94%20Portland%20Rd_files/style1_responsive.css">



<!-- Google Fonts -->
<link href="94%20Portland%20Rd_files/css.css" rel="stylesheet" type="text/css">

<!--[if lte IE 8]>
<link rel="stylesheet" type="text/css" href="/it_property2/templates/it_property2/css/ie8.css" />
<![endif]-->

<!--[if lte IE 8]>
<link rel="stylesheet" type="text/css" href="/it_property2/IT_THEME/css/ie8.css" />
<script src="/it_property2/templates/it_property2/js/respond.min.js"></script>
<![endif]-->



<!--[if lt IE 9]>
    <script src="/it_property2/media/jui/js/html5.js"></script>
<![endif]-->
...
<script src="94%20Portland%20Rd_files/common.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/util.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/geometry.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/directions.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/menu.js" async="" charset="utf-8" type="text/javascript"></script><style type="text/css">.fb_hidden{position:absolute;top:-10000px;z-index:10001}.fb_reposition{overflow:hidden;position:relative}.fb_invisible{display:none}.fb_reset{background:none;border:0;border-spacing:0;color:#000;cursor:auto;direction:ltr;font-family:"lucida grande", tahoma, verdana, arial, sans-serif;font-size:11px;font-style:normal;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:1;margin:0;overflow:visible;padding:0;text-align:left;text-decoration:none;text-indent:0;text-shadow:none;text-transform:none;visibility:visible;white-space:normal;word-spacing:normal}.fb_reset>div{overflow:hidden}.fb_link img{border:none}@keyframes fb_transform{from{opacity:0;transform:scale(.95)}to{opacity:1;transform:scale(1)}}.fb_animate{animation:fb_transform .3s forwards}
...
.fb_iframe_widget{display:inline-block;position:relative}.fb_iframe_widget span{display:inline-block;position:relative;text-align:justify}.fb_iframe_widget iframe{position:absolute}.fb_iframe_widget_fluid_desktop,.fb_iframe_widget_fluid_desktop span,.fb_iframe_widget_fluid_desktop iframe{max-width:100%}.fb_iframe_widget_fluid_desktop iframe{min-width:220px;position:relative}.fb_iframe_widget_lift{z-index:1}.fb_hide_iframes iframe{position:relative;left:-10000px}.fb_iframe_widget_loader{position:relative;display:inline-block}.fb_iframe_widget_fluid{display:inline}.fb_iframe_widget_fluid span{width:100%}.fb_iframe_widget_loader iframe{min-height:32px;z-index:2;zoom:1}.fb_iframe_widget_loader .FB_Loader{background:url(https://static.xx.fbcdn.net/rsrc.php/v2/y9/r/jKEcVPZFk-2.gif) no-repeat;height:32px;width:32px;margin-left:-16px;position:absolute;left:50%;z-index:4}</style><script src="94%20Portland%20Rd_files/button.js" async="" charset="utf-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/stats.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/infowindow.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/marker.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/AuthenticationService.Authenticate" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/map.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/streetview.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/controls.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/places_impl.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/onion.js" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/GeoPhotoService.SingleImageSearch" charset="UTF-8" type="text/javascript"></script><script src="94%20Portland%20Rd_files/PlaceService.FindPlaces" charset="UTF-8" type="text/javascript"></script></head>
